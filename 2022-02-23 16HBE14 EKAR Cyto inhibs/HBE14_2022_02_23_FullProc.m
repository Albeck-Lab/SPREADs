...
filterp.fts = fts;
filterp.dlength = 120; %16 hour min for tracks
...
plotMe = {'EKAR'};
plot_by_ND('arcosplot',dataloc,'analysischan',{'freq','mean dur','mean spread size'},'channel',plotMe,'plottype',{'bar_v2'}','tx_order',2,'exclude',{'BrefeldinA','PD','EGF','ERKi'},'aftertreatment', 2,'combinexys',false)
