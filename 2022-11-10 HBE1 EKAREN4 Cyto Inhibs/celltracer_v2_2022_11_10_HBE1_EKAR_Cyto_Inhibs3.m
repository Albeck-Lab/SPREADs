...
function [ip, op] = celltracer_v2_2022_11_10_HBE1_EKAR_Cyto_Inhibs3()
...
ip.indsz.t  = [250];   %Number of Time points
...
op.xypos    = [49,51,55:59,63,85];       %Indices of XY positions to process
op.trng     = [1:250];       %Start and End indices of Time to process
op.nW       = 6;        %Number of parallel workers to use
%   Optional procedures
