...
function [ip, op] = celltracer_v2_2022_09_22_pHBE_EKAREN4_CytokineArray5()
...
ip.fname = 'D:\Holder\2022-09-22 pHBE EKAREN4 Cytokine Array.nd2';
%   Target save name for processed data files (include path)
ip.sname = '\\mcb.ucdavis.edu\shared\Data\mcb_labs\albeck\ProcessedData\Nick\2022-09-22 pHBE EKAREN4 Cytokine Array\2022-09-22 pHBE EKAREN4 Cytokine Array';  
...
ip.indsz.t  = [274];   %Number of Time points
...
%        *+ = Ensure for Field Flattening )
    ...
    ip.bkmd.exp.Exposure   =   {125, 125};  %Exposure times (ms) ++
...
op.xypos    = [1,65:80];       %Indices of XY positions to process
op.zstack   = [1];
op.trng     = [1:274];       %Start and End indices of Time to process
