...
dataloc = DatalocHandler('sensors',sensors,'filterp',filterp,'normalizedata','ERKTR','saveit',false,'load',false);
plot_by_ND('treatment', dataloc, 'plottype', {'mean'},'channel', 'ERKTR','tx_order', 2,'aftertreatment',2,'tmaxaftertx',24,'combinexys',true,'ymn',0.5,'ymx',2.5)
...
dataloc = DatalocHandler('dataloc',dataloc,'pulseanalysis',{'ERKTR','nERKTR'},'pulsefts',pfts,'saveit',false);
