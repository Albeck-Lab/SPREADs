...
filterp.fts = fts;
filterp.dlength = 100; % 6 hour min for tracks
...
% plot_by_ND('treatment', dataloc, 'plottype', {'sorted heatmap'},'channel',{'EKAR'},'ncells',200,'tx_order',2','tmaxaftertx',24)
% plot_by_ND('treatment', dataloc, 'plottype', {'spatial heatmap'},'channel',{'EKAR'},'ncells',200,'tx_order',2,'tmaxaftertx',24,'combinexys',false)
