...
function [ip, op] = celltracer_v2_2023_10_14_16HBE14_EKAR2()
...
%       (** = Critical for all runs, ++ = Only for objbias)
    ...
    ip.bkmd.exp.Exposure   =   {100, 100};  %Exposure times (ms) ++
...
op.xypos    = [69,70,73];       %Indices of XY positions to process
