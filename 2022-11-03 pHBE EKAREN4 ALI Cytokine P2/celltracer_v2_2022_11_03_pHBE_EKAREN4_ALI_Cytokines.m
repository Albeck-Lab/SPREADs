...
function [ip, op] = celltracer_v2_2022_11_03_pHBE_EKAREN4_ALI_Cytokines
...
ip.indsz.t  = [248];   %Number of Time points
...
ip.xyshift.frame = [8];      %Time indices of first shifted frames
...
%        *+ = Ensure for Field Flattening )
    ...
    ip.bkmd.exp.ExWL       =   {[440],[514]};   %Wavelength
    %   ----- ----------------------------------------------- -----
...
op.xypos    = [1:18,37];       %Indices of XY positions to process
op.zstack   = [1];
