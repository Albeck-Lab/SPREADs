...
function [ip, op] = celltracer_v2_2023_09_06_HBE1_EKAR2()
...
op.xypos    = [48:96];       %Indices of XY positions to process
...
op.seg.sigthresh = [800]; %[Optional] Minimum intensity of 'good' signal
