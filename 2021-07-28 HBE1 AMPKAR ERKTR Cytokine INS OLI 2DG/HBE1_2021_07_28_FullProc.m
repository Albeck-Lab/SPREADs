...
fts(4).t = 'Min'; fts(4).c = 'AMPKAR'; fts(4).p = 0.1;
fts(5).t = 'Max'; fts(5).c = 'AMPKAR'; fts(5).p = 0.9;
...
plot_by_ND('treatment', dataloc, 'plottype', {'mean'},'channel', 'AMPKAR','tx_order', 1,'aftertreatment',1,'tmaxaftertx',24,'combinexys',true)
